    ...
    return (
        <>
            <div className="flex gap-2">
                <input type="text" value={photoLink} onChange={ev => setPhotoLink(ev.target.value)} placeholder={'Add using a link.. Only PNG and JPEG Accepted.'} />
            ...
            <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                ...
                <label className="h-32 cursor-pointer flex  justify-center gap-1 border bg-transparent rounded-2xl p-2 text-2xl text-gray-600 items-center">
